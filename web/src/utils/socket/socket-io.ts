...
import { setStatus } from '@/store/ws'
...
export class SocketIOWrapper {
  ...
  _init() {
    ...
    // this.socketInstance = IO(import.meta.env.VITE_APP_BASE_SOCKET_NSP, {
    //   path: import.meta.env.VITE_APP_BASE_SOCKET_PATH,
    //   transports: ['websocket'],
    //   query: { token }
    // })
